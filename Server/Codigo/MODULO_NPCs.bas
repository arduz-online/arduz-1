...
Sub MuereNpc1(ByVal NpcIndex As Integer, ByVal UserIndex As Integer)
'
'Author: Unknown
'Llamado cuando la vida de un NPC llega a cero.
'Last Modify Date: 24/01/2007
...
Sub CrearNPC(NroNPC As Integer, mapa As Integer, OrigPos As WorldPos, Optional bando As eKip = eKip.eNone)
